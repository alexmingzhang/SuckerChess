...
g++-12 -std=c++20 ${GCC_WARNING_FLAGS} ${GCC_OPT_FLAGS} -DSUCKER_CHESS_USE_DETERMINISTIC_SEED -DSUCKER_CHESS_USE_COMPRESSED_CHESS_MOVE ${SOURCES} -o SuckerChessGCCM
clang++ -std=c++20 ${CLANG_WARNING_FLAGS} ${CLANG_OPT_FLAGS} -DSUCKER_CHESS_USE_DETERMINISTIC_SEED -DSUCKER_CHESS_USE_COMPRESSED_CHESS_MOVE ${SOURCES} -o SuckerChessClangM
g++-12 -std=c++20 ${GCC_WARNING_FLAGS} ${GCC_OPT_FLAGS} -DSUCKER_CHESS_USE_DETERMINISTIC_SEED -DSUCKER_CHESS_USE_COMPRESSED_CHESS_PIECE -DSUCKER_CHESS_USE_COMPRESSED_CHESS_MOVE ${SOURCES} -o SuckerChessGCCPM
clang++ -std=c++20 ${CLANG_WARNING_FLAGS} ${CLANG_OPT_FLAGS} -DSUCKER_CHESS_USE_DETERMINISTIC_SEED -DSUCKER_CHESS_USE_COMPRESSED_CHESS_PIECE -DSUCKER_CHESS_USE_COMPRESSED_CHESS_MOVE ${SOURCES} -o SuckerChessClangPM
